...
public class ItemEditor : EditorWindow
{
    ...
    private void GetItemDetails()
    {
        ...
        itemDetailsSection.Q<EnumField>("ItemType").Init(activeItem.itemType); //这样才能点击
        ...
        itemDetailsSection.Q<Toggle>("CanDropped").value = activeItem.canDrop;
        itemDetailsSection.Q<Toggle>("CanDropped").RegisterValueChangedCallback(evt =>
        {
            activeItem.canDrop = evt.newValue;
        });

        itemDetailsSection.Q<Toggle>("CanCarried").value = activeItem.canCarry;
